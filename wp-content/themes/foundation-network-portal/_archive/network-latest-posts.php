    ...
    switch($display_type) {
        ...
        case "ulist":
            $html_tags = array(
                ...
                'wtitle_c' => "</h2>",
                'item_o' => "<article id='post-id' class='clearfix network-post $wrapper_list_css' role='article'>",
                'item_c' => "</article>",
                'content_o' => "<div class='nlposts-container nlposts-ulist-container $nlp_instance'>",
                'content_c' => "</div>",
                'meta_o' => "<header><p class='meta'>",
                'meta_c' => "</p></header>",
                'thumbnail_o' => "<div class='post-thumbnail'>",
                'thumbnail_c' => "</div>",
                'thumbnail_io' => "<iv class='post-thumbnail'>",
                'thumbnail_ic' => "</div></li>",
